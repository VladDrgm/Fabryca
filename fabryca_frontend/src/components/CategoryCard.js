...
const CategoryCard = ({category, ticketList, setTicketList, categoryList}) => {
  ...
  return (
    ...
    {localTicketList.length !== 0 ? localTicketList.map(ticket =>
        ( <TicketCard setTicketList={setTicketList} ticketList={ticketList} ticket={ticket} category={category} categoryList={categoryList} key={ticket.createdAt + ticket.title}/> )) : <h4>There aren't any tickets for this category</h4>}
    </section>
